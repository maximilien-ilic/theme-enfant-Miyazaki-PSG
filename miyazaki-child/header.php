...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?> >
		...
		<a class="faux-button skip-link blanc" href="#site-content"><?php _e( 'Skip to the content', 'miyazaki' ); ?></a>
				...
				<div class="header-left ">
					...
					if ( ! $show_big_front_title ) :
						...
						elseif ( is_front_page() ) : ?>
							...
							<h1 class="site-title "><a class="blanc" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a></h1>
	
						<?php else : ?>

							<p class="site-title "><a class="blanc" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a></p>
